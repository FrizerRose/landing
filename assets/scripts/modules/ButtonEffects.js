...
import { Renderer, Camera, Geometry, Program, Texture, Mesh, Vec2, GPGPU } from 'ogl';
...
export default class extends module {
    ...
    setup() {
...

      {
          ...
          const buttonEffects = this.el;
          // console.log(buttonEffects.clientHeight);
          buttonEffects.appendChild(gl.canvas);
          // document.body.appendChild(gl.canvas);
          gl.clearColor(0.122, 0.122, 0.122, 1);

          const camera = new Camera(gl, { fov: 45 });
          camera.position.set(0, 0, 5);

          function resize() {
              renderer.setSize(this.BCR.width, this.BCR.height);
          ...
          function updateMouse(e) {
            // console.log("aaaaaaaaaaaaaaaa", e.pageX);
